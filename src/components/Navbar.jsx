...
import { AppBar, Toolbar, styled, Typography, InputBase, Box, MenuItem, Menu } from '@mui/material'
...
export const Navbar = () => {
  ...
  return (
    <AppBar position="sticky">
      <StyledToolbar>
        <Typography variant="h6" sx={{ display: { xs: "none", sm: "block" } }}>Pet Dev</Typography>
